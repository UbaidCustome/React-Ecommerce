          ...
          <div className='col-md-9'>
            <div className='card shadow'>
                <div className='card-body p-4'>
                    ...
                    {
                        loading == false && categories.length == 0 && <div className='text-center py-5'>Categories not found</div>
                    }
                    {
                            ...
                            <tbody>
                                {
                                        ...
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td>{category.name}</td>
                                                <td>
                                                    {category.status == 0 ? <span className='badge text-bg-danger'>Blocked</span> : <span className='badge text-bg-success'>Active</span>} 
                                                </td>
                                                <td>
                                                    ...
                                                    <Link to="#" className='text-danger ms-2'>
