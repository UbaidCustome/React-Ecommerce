            ...
            try {
                ...
                .then(data => {
                    if(data.status == 1) {
                        ...
                        const newdata = brands.filter(brands => brands.id != id)
                        setBrands(newdata)
                    }
                    else{
                        console.log(data.message);
    ...
    <div className='container'>
        <div className='row'>
          <div className='d-flex justify-content-between mt-5 pb-3'>
            <h3 className='pb-0 mb-0'>All Brands</h3>
          ...
          <div className='col-md-9'>
            <div className='card shadow'>
                <div className='card-body p-4'>
                    ...
                    {
                        loading == false && brands.length == 0 && <div className='text-center py-5'>Brands not found</div>
                    }
                    {
                                    ...
                                    brands.map((brand, index) => {
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td>{brand.name}</td>
                                                <td>
                                                    {brand.status == 0 ? <span className='badge text-bg-danger'>Blocked</span> : <span className='badge text-bg-success'>Active</span>} 
                                                </td>
                                                <td>
                                                    ...
                                                    <Link to="#" className='text-danger ms-2' onClick={()=>deleteBrand(brand.id)}>
